                            ...
                            >
                                ...
                                <Stack divider={<Divider/>}>
                                    ...
                                    >
                                        ...
                                        <ApiState query={communityLinks} loadingLabel="Loading Community Links…">
                                            {(links) => {
                                                        ...
                                                        {links.map(({href, icon, alt}, index) => {
                                                                ...
                                                                return (
                                                                    <Link key={index} to={href}>
                                                                        <img src={imgSrc} style={{ width: "3rem", marginLeft: '0.5rem', marginRight: '0.5rem' }}
                                                                             alt={alt}/>
                                                                    </Link>
                                                                )
                                                            }
                ...
                <Container maxWidth="md">
                    ...
                    <Stack spacing={2.5} sx={{color: "text.secondary"}}>
                        <Typography variant="body1" sx={{lineHeight: 1.8}}>
                            ...
                            We are not affiliated with, endorsed by, or in any way
                            connected to Atlas Reality,
                            Inc., the developers of Atlas Earth.
                        </Typography>
                        <Typography variant="body1" sx={{lineHeight: 1.8}}>
                            All trademarks, service marks, trade names, and game content
                            referenced on this
                            site are the property of their respective owners. References
                            to Atlas Earth, Atlas
                            Bucks, Atlas Coins, and related terms are used solely for
                            informational and
                            editorial purposes.
                        </Typography>
                        <Typography variant="body1" sx={{lineHeight: 1.8}}>
                            ...
                            our best understanding of how the game works based on
                            community experience. Game
                            mechanics, payout structures, and policies can change at any
                            time. Always refer to
                            the{" "}
                            <Typography
                                component="a"
                        ...
                        <Typography variant="body1" sx={{lineHeight: 1.8}}>
                            Nothing on this site constitutes financial advice. Atlas
                            Earth should be approached
                            as a game, not as a financial investment.
                        </Typography>
                    </Stack>

                    <Stack
                        sx={{flexDirection: {xs: "column", sm: "row"}, gap: 2, mt: 6}}>
                        <Button
                            component={Link}
                            to="/faq"
                            variant="contained"
